package com.hiumx.api_gateway.config;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.hiumx.api_gateway.dto.response.ApiResponse;
import com.hiumx.api_gateway.service.IdentityService;
...
public class AuthenticationFilterConfig implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        log.info("Authentication filter here...");
